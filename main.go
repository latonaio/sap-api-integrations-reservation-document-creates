...
import (
	sap_api_caller "sap-api-integrations-reservation-document-creates/SAP_API_Caller"
	sap_api_input_reader "sap-api-integrations-reservation-document-creates/SAP_API_Input_Reader"
	"sap-api-integrations-reservation-document-creates/config"
...
func main() {
	...
	inputSDC := fr.ReadSDC("./Inputs/SDC_Reservation_Document_Header_sample.json")
	...
	caller.AsyncPostReservationDocument(
		header,
		item,
		accepter,
	)
